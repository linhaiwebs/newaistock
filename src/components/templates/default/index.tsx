...
export function TemplateDefault({ template, getContent }: TemplateProps) {
  ...
  const features = [
    ...
    { id: 'bond', icon: BarChart3, label: getContent('feature_bond', 'Bond'), color: 'bg-red-700' },
    { id: 'realestate', icon: Home, label: getContent('feature_realestate', 'Real Estate'), color: 'bg-gray-700' },
    { id: 'etfs', icon: Target, label: getContent('feature_etfs', 'ETFs'), color: 'bg-amber-700' },
    ...
    { id: 'other', icon: Settings, label: getContent('feature_other', 'Other'), color: 'bg-amber-800' },
  ];

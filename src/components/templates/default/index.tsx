...
import { Sparkles, TrendingUp, BarChart3, Brain, Target, Zap, Loader2, ArrowRight, ArrowLeft } from 'lucide-react';
...
export function TemplateDefault({ template, getContent }: TemplateProps) {
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          {diagnosis.redirectUrl && (
            <button
              ...
              className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 py-4 px-10 rounded-2xl transition-all duration-200 flex items-center gap-3 group font-semibold shadow-lg hover:shadow-xl"
            >
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <StockDecorations variant="default" />
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
              ...
              <input
                ...
                placeholder="例: 1031"
                className="w-full px-6 py-4 text-lg border-3 border-yellow-400 rounded-2xl focus:border-yellow-300 focus:ring-4 focus:ring-yellow-400/30 outline-none transition-all bg-white text-gray-900 placeholder-gray-400 font-medium"
              ...
              <button
                ...
                className="w-full mt-6 bg-yellow-400 hover:bg-yellow-500 text-gray-900 py-4 px-8 rounded-2xl font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group"
              >
                {diagnosis.loading ? (
                  <>

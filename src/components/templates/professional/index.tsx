        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          {diagnosis.redirectUrl && (
            <button
              ...
              className="bg-rose-500 hover:bg-rose-600 text-white py-4 px-10 rounded-full transition-all duration-200 flex items-center gap-3 group font-normal shadow-md hover:shadow-lg text-base"
            >
              <span>詳細を見る</span>

        ...
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="max-w-2xl mx-auto mb-16">
            ...
            <div className="space-y-4">
              <div className="bg-gray-800/40 rounded-3xl p-6 border border-gray-700/50">
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    placeholder="例: 1031"
                    className="flex-1 px-6 py-4 text-lg border-2 border-gray-600 rounded-2xl focus:border-rose-400 focus:ring-2 focus:ring-rose-400/30 outline-none transition-all bg-white text-gray-900 placeholder-gray-400"
                  ...
                  <button
                    ...
                    className="px-8 bg-rose-500 hover:bg-rose-600 text-white py-4 rounded-full font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2 group whitespace-nowrap"
                  >
                    {diagnosis.loading ? (
                      <>
              ...
              <button
                className="w-full bg-transparent hover:bg-gray-800/50 text-rose-400 py-4 px-8 rounded-full font-semibold text-lg border-2 border-rose-500/60 transition-all duration-200 flex items-center justify-center gap-2"
              >

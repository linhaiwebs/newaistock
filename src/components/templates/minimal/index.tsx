...
export function TemplateMinimal({ template, getContent }: TemplateProps) {
  ...
  const theme = getTemplateTheme('minimal');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50/30 via-white to-white flex flex-col">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-gray-900 rounded-3xl px-6 py-8 mb-4">
            <div className="flex items-center justify-center mb-4">
              <AILogo className="w-12 h-12" theme="emerald" />
            </div>
            ...
            <div className="flex flex-col gap-3">
              <input
                ...
                className="w-full px-5 py-3 rounded-full text-base focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white text-gray-900 placeholder-gray-400"
              ...
              <button
                ...
                className="w-full bg-emerald-500 hover:bg-emerald-600 text-white py-3 px-6 rounded-full font-normal text-base disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2"
              >
                {diagnosis.loading ? (

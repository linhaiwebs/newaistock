          ...
          <div className="max-w-2xl mx-auto mb-16">
            ...
            <div className="bg-gray-800/40 rounded-3xl p-8 border border-gray-700/50">
              ...
              <input
                ...
                placeholder="例: 1031"
                className="w-full px-6 py-4 text-lg border-2 border-gray-600 rounded-2xl focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/30 outline-none transition-all bg-white text-gray-900 placeholder-gray-400"
              ...
              <button
                ...
                className="w-full mt-6 bg-emerald-500 hover:bg-emerald-600 text-white py-4 px-8 rounded-full font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2 group"
              >
                {diagnosis.loading ? (
                  <>
              ...
              <button
                className="w-full mt-4 bg-transparent hover:bg-gray-800/50 text-emerald-400 py-4 px-8 rounded-full font-semibold text-lg border-2 border-emerald-500/60 transition-all duration-200 flex items-center justify-center gap-2"
              >
